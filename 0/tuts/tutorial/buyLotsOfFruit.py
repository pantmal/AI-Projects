...
def buyLotsOfFruit(orderList):
    """This function takes an orderList as an argument, meaning a list with tuples of two items: fruit type and its cost.
        ...
        the cost of each fruit by multiplying its price from the orderList and the its value from the fruitPrices dictionary.
        It then adds each cost to total amount that will be returned. 
    """
    totalCost = 0.0
